...
autoapi_dirs = ["../../{{ cookiecutter.__project_slug }}"]
...
sphinx_autodoc_typehints = (
    "both"  # Sphinx-native. Not as good as sphinx_autodoc_typehints
)
...
html_show_copyright = (
    True  # Shows copyright using the company and author specified above
)
